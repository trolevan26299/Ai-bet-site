...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      style={{ height: `${window.innerHeight}px`, bottom: "0px", oveflowY: "auto" }}
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Title ref={ref} className={cn("text-md font-semibold  tracking-tight", className)} {...props} />
));
